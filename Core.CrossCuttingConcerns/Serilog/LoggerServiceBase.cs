...
/// <summary>
/// LoggerServiceBase sınıfı : Gönderdiğimiz logger'in implementasyonlarını gerçekleştirecek.
/// </summary>
public abstract class LoggerServiceBase
{
    ...
    public void Verbose(string message) => Logger.Verbose(message); // detaylı log
